  ...
  <body>
        ...
        <nav>
          ...
          <div class="home" id="home">
            ...
            <img class="rectangle" src="{{ asset('images/homePage/elements/Rectangle5.png') }}" alt="" />
            <img class="rectangle" src="{{ asset('images/homePage/elements/Rectangle6.png') }}" alt="" />
            <img class="rectangle" src="{{ asset('images/homePage/elements/Rectangle7.png') }}" alt="" />
          ...
          <div class="segment-2">
            ...
            <img src="{{ asset('images/homePage/footer-thumbnail.png') }}" alt="" />
          </footer>
